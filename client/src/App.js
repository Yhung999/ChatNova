...
function App() {
  ...
  const fetchContacts = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/contacts/${currentUser.username}`);
      const data = await response.json();
      setContacts(data);
    } catch (error) {
  ...
  const fetchContactRequests = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/contact-requests/${currentUser.username}`);
      const data = await response.json();
  ...
  const searchForUsers = async (query) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/search-users/${currentUser.username}/${query}`);
      const data = await response.json();
      setSearchUsers(data);
    } catch (error) {
  ...
  const sendContactRequest = async (toUsername) => {
    ...
    try {
      await fetch('http://localhost:5000/api/contact-request', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const respondToContactRequest = async (requestId, accept) => {
    try {
      await fetch('http://localhost:5000/api/contact-request/respond', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          requestId, 
